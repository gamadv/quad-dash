...
import { GetOrdersResponse } from '@/services/get-orders'
...
export function HistoryTableRow({ order }: HistoryTableRowProps) {
    ...
    <TableRow>
      <TableCell>
        <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
          ...
          <HistoryDetails open={isDetailsOpen} orderId={order.orderId} />
        </Dialog>
      </TableCell>
